...
/***/ "./includes/block-editor/blocks/call/edit.js":
/*!***************************************************!*\
  !*** ./includes/block-editor/blocks/call/edit.js ***!
  \***************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./editor.scss */ "./includes/block-editor/blocks/call/editor.scss");
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./style.scss */ "./includes/block-editor/blocks/call/style.scss");
...
const templates = {
  ...
  two: [["core/heading", {
    ...
    placeholder: "Why I should click the Button"
  }], ["core/columns", {}, [["core/column", {}, [["core/button", {
    placeholder: "Let's talk"
...
const createTemplate = templateBlueprint => {
  const template = templateBlueprint.map(block => {
    return createBlock(block[0], block[1], block[2] ? createTemplate(block[2]) : []);
  });
  return template;
};
...
function edit(props) {
  ...
  })))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_library_flex_FlexControls__WEBPACK_IMPORTED_MODULE_1__["default"], {
    handleAttribute: handleAttribute
  }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", blockProps, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(InnerBlocks, {
...
/***/ "./includes/block-editor/blocks/call/index.js":
/*!****************************************************!*\
  !*** ./includes/block-editor/blocks/call/index.js ***!
  \****************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _library_flex_FlexControls__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../library/flex/FlexControls */ "./includes/library/flex/FlexControls.jsx");
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./edit */ "./includes/block-editor/blocks/call/edit.js");
/* harmony import */ var _save__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./save */ "./includes/block-editor/blocks/call/save.js");
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./style.scss */ "./includes/block-editor/blocks/call/style.scss");
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./editor.scss */ "./includes/block-editor/blocks/call/editor.scss");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./block.json */ "./includes/block-editor/blocks/call/block.json");
...
settings.attributes = (0,_library_flex_FlexControls__WEBPACK_IMPORTED_MODULE_1__.addAttributes)(settings.attributes); // Add Flex settings

/* harmony default export */ __webpack_exports__["default"] = ((0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.registerBlockType)(name, { ...settings,
...
/***/ "./includes/block-editor/blocks/call/save.js":
/*!***************************************************!*\
  !*** ./includes/block-editor/blocks/call/save.js ***!
  \***************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _library_flex_FlexControls__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../library/flex/FlexControls */ "./includes/library/flex/FlexControls.jsx");
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./style.scss */ "./includes/block-editor/blocks/call/style.scss");
...
function save(props) {
  const blockProps = _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.useBlockProps.save({
    style: { ...(0,_library_flex_FlexControls__WEBPACK_IMPORTED_MODULE_2__.styles)(props.attributes)
    }
  });
...
/***/ "./includes/block-editor/blocks/call/editor.scss":
/*!*******************************************************!*\
  !*** ./includes/block-editor/blocks/call/editor.scss ***!
  \*******************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./includes/block-editor/blocks/call/style.scss":
/*!******************************************************!*\
  !*** ./includes/block-editor/blocks/call/style.scss ***!
  \******************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./includes/block-editor/blocks/call/block.json":
/*!******************************************************!*\
  !*** ./includes/block-editor/blocks/call/block.json ***!
  \******************************************************/
/***/ (function(module) {

module.exports = JSON.parse('{"apiVersion":2,"name":"create-block/call","version":"0.1.0","title":"call","category":"widgets","description":"","supports":{"html":false,"align":true,"alignWide":true,"color":{"text":true,"background":true,"link":true,"gradients":true},"spacing":{"margin":true,"padding":true},"typography":{"fontSize":true,"lineHeight":true}},"attributes":{"template":{"type":"string","default":"one"},"heading":{"type":"string","source":"text","selector":"h1"},"subHeading":{"type":"string","source":"text","selector":"h2"},"buttonText":{"type":"string","source":"text","selector":"button"}},"example":{"attributes":{"heading":"Your Heading Goes Here","subHeading":"Why I should click the Button","buttonText":"Let\'s talk"}},"textdomain":"create-block","editorScript":"file:../../../../build/call.js","editorStyle":"file:../../../../build/call.css","style":"file:../../../../build/style-call.css"}');
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["./style-call"], function() { return __webpack_require__("./includes/block-editor/blocks/call/index.js"); })
